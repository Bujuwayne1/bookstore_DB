...
CREATE TABLE `cust_order` (
  ...
  CONSTRAINT `cust_order_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`customer_id`),
...
INSERT INTO `cust_order` VALUES (2,1,'2025-04-12 21:56:02',6,6);
...
-- Dump completed on 2025-04-13 23:00:02
